  ...
  return (
    <div className="rounded-lg p-6">
      <div className="flex justify-between">
        ...
        <button class="flex justify-center gap-2 items-center rounded-md bg-primary px-8 py-1.5text-sm/6 font-semibold text-white hover:bg-primary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary active:bg-primary/65">
          <svg
