...
export default function ErroDialogo({showPopUp, closePopUp, titulo, mensagem, confirmarDialogo, fecharDialogo }) {
  ...
  return (
    ...
    //   className="fixed inset-0 m-0 size-full max-h-none max-w-none bg-transparent p-0 backdrop:bg-gray-500/75 backdrop:transition-opacity open:animate-in open:fade-in-0"
    // >
      <div
        tabIndex="0"
